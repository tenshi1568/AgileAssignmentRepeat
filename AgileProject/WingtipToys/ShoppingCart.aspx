...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ShoppingCartTitle" runat="server" class="ContentHead"><h1>Your OrderList</h1></div>
    ...
    <tr>
      ...
      <td>
          <asp:Button ID="checkButton" runat="server" OnClick="checkButton_Click" Text="CheckOut" />
      </td>
    </tr>
    </table>
</asp:Content>